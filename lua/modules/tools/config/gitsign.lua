require('gitsigns').setup ({
  on_attach = function(bufnr)
    ...
    -- Actions
    map('n', '<leader>gs', ':Gitsigns stage_hunk<CR>', { desc = "git stage_hunk" })
    map('v', '<leader>gs', ':Gitsigns stage_hunk<CR>', { desc = 'git stage_hunk' })
    map('n', '<leader>gr', ':Gitsigns reset_hunk<CR>', { desc = 'git reset_hunk' })
    map('v', '<leader>gr', ':Gitsigns reset_hunk<CR>', { desc = 'git reset_hunk' })
